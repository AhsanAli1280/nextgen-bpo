...
export const metadata: Metadata = {
  metadataBase: new URL('https://nextgenbpo.com'),
  ...
  openGraph: { type: 'website', locale: 'en_US', url: 'https://nextgenbpo.com', siteName: BRAND.name, title: SEO.title, description: SEO.description },
